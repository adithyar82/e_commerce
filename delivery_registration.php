			...
			<div class="row">
				<div class="col-md-6" style="margin-left:27%;">
					<div class="register-form">
						...
						<form method ="POST" action = "delivery_register.php">
                            ...
                            <input type="radio" id="delivery" name="role" value="delivery"
                                    >
                            <label for="huey">delivery</label>
                            </div>

                            <div>
                            <input type="radio" id="shop_delivery" name="role" value="delivery_shop">
                            <label for="dewey">shop_delivery</label>
                            </div>
                            <br>
