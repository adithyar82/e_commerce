    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/js/bootstrap.min.js"></script>
		...
		<body>
			...
			<!-- Start brand Area -->
							...
							<?php
							include('connect_db.php');
							$sql = "SELECT * FROM items WHERE product_quantity < 5";
							$result = $conn->query($sql);
							if($result->num_rows>0){
								while($row = $result->fetch_assoc()){
									...
									<h3><br> Item Name &emsp; &emsp; &nbsp; &nbsp; &nbsp; &nbsp; : '.$item_name.' <br><br> Product Quantity &nbsp; &nbsp; &nbsp;: '.$product_quantity.'<br><br> Product Cost &emsp; &nbsp; &nbsp;: '.$final_cost.'<br><br>';
									echo'
									</div>
