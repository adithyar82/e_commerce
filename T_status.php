        ...
        <section class="brand-area pb-100">
            <div class="container">
                <div class="logo-wrap">
                    ...
                    <br>
                    <h1 class="d-flex justify-content-center" style="color:#ffaa1d;">Payment Pending</h1><br>
                    <h3>Order Id:</h3><br>
                    <h3>First Name:</h3><br>
                    <h3>Last Name:</h3><br>
                    <h3>Transaction Id:</h3><br>
                    <h3>Transaction Time:</h3><br>
                    <h3>Transaction Type:</h3><br>
                    <button style="width:200px; background-color:#ffaa1d; color:white;" onclick="myFunction_1()">Product Details</button>
                        <div id="myDIV_1">
                            <br>
                            <h4>Product Name :</h4><br>
                            <h4>Product Price :</h4><br>
        ...
        <section class="brand-area pb-100">
            <div class="container">
                <div class="logo-wrap">
                    ...
                    <br>
                    <h1 class="d-flex justify-content-center" style="color:red;">Payment Canceled</h1><br>
                    <h3>Order Id:</h3><br>
                    <h3>First Name:</h3><br>
                    <h3>Last Name:</h3><br>
                    <h3>Transaction Id:</h3><br>
                    <h3>Transaction Time:</h3><br>
                    <h3>Transaction Type:</h3><br>
                    <button style="width:200px; background-color:red; color:white;" onclick="myFunction_2()">Product Details</button>
                        <div id="myDIV_2">
                            <br>
                            <h4>Product Name :</h4><br>
                            <h4>Product Price :</h4><br>
