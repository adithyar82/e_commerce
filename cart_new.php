                        ...
                        <div class="col-first">
                            <h1>Shopping Cart</h1>
                             <nav class="d-flex align-items-center justify-content-start">
                                ...
                                <a href="cart_new.php">Shopping Cart</a>
                            </nav>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-2 col-6">
                            <div class="quantity-container d-flex align-items-center mt-15">
                                ...
                                <div class="arrow-btn d-inline-flex flex-column">
                                    <button href="quantity.php" class="increase arrow" type="button" title="Increase Quantity"><span class="lnr lnr-chevron-up"></span></button>
                                    <button href="quantity.php" class="decrease arrow" type="button" title="Decrease Quantity"><span class="lnr lnr-chevron-down"></span></button>
                                </div>
                            </div>
                        </div>
