...
?>
	...
	<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/js/bootstrap.min.js"></script>
		...
		<link href="https://fonts.googleapis.com/css?family=Poppins:100,200,400,300,500,600,700" rel="stylesheet"> 
			...
			.slide-holder
			{
				width:767px;  /*set the size of our slide holder*/
				height:586px;
			...
			.slide-group {
				width:3068px; /*width of our images combined*/
				height:1172px;
			...
			@keyframes animate {
				...
				6% {left:0px;}
				15% {left:-767px;}  /*second image */
				21% {left:-767px;}
				30% {left:-1534px;}  /*third image */
				36% {left:-1534px;}
				45% {left:-2301px;}   /*forth image */
				51% {left:-2301px;}
				66% {left:-1534px;}  /*third image */
				65% {left:-1534px;}
				76% {left:-767px;}  /*second image*/
				80% {left:-767px;}
