									...
									<div class="content">
									    <a href="category.php" target="_blank">
									      <div class="content-overlay"></div>
									  		 <img class="content-image img-fluid d-block mx-auto" src="img/c12.jpg" alt="">
									      <div class="content-details fadeIn-bottom">
									        <h3 class="content-title">Food and Beverages</h3>
									      </div>
									    </a>
									</div>
								</div>
								<div class="col-lg-6 col-md-6 mb-30">
									<div class="content">
									    <a href="category.php" target="_blank">
									      ...
									      <div class="content-details fadeIn-bottom">
									        <h3 class="content-title">Medicines</h3>
									      </div>
									    </a>
									</div>
								</div>
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-3 col-md-6 single-product">
						  ...
						  <div class="price">
								  <h5 class="text-white">Induction Stove</h5>
								  <h3 class="text-white"><del style = "color : black">Rs 2500.00</del></h3>
						  		<h3 class="text-white">Rs1500.00</h3>
						   </div>
						</div>	
						<div class="col-lg-3 col-md-6 single-product">
						  <div class="content">
						      <div class="content-overlay"></div>
						  		 <img class="content-image img-fluid d-block mx-auto" src="img/c19.jpg" alt="">
						      <div class="content-details fadeIn-bottom">
							        <div class="bottom d-flex align-items-center justify-content-center">
										<a href="category.php"><span class="lnr lnr-heart"></span></a>
										<!-- <a href="#"><span class="lnr lnr-layers"></span></a>
										<a href="#"><span class="lnr lnr-cart"></span></a> -->
										<a href="#" data-toggle="modal" data-target="#exampleModal"><span class="lnr lnr-frame-expand"></span></a>
									</div>
						  ...
						  <div class="price">
								  ...
								  <h3 class="text-white"><del style = "color : black">Rs 6000.00</del></h3>
						  		<h3 class="text-white">Rs 4500.00</h3>
						   </div>							  
						</div>	
						<div class="col-lg-3 col-md-6 single-product">
						  <div class="content">
						      <div class="content-overlay"></div>
						  		 <img class="content-image img-fluid d-block mx-auto" src="img/c20.jpg" alt="">
						      <div class="content-details fadeIn-bottom">
							        <div class="bottom d-flex align-items-center justify-content-center">
										<a href="#"><span class="lnr lnr-heart"></span></a>
										<!-- <a href="#"><span class="lnr lnr-layers"></span></a>
						  ...
						  <div class="price">
								  <h5 class="text-white">Coffee Maker</h5>
								  <h3 class="text-white"><del style = "color : black">Rs 250.00</del></h3>
						  		<h3 class="text-white">Rs 150.00</h3>
						   </div>							  
						</div>	
						<div class="col-lg-3 col-md-6 single-product">
						  <div class="content">
					      	<div class="content-overlay"></div>
					  		 <img class="content-image img-fluid d-block mx-auto" src="img/c21.jpg" alt="">
						      <div class="content-details fadeIn-bottom">
							        <div class="bottom d-flex align-items-center justify-content-center">
										<a href="#"><span class="lnr lnr-heart"></span></a>
										<!-- <a href="#"><span class="lnr lnr-layers"></span></a>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-lg-3 col-md-6 single-product">
						  <div class="content">
						      <div class="content-overlay"></div>
						  		 <img class="content-image img-fluid d-block mx-auto" src="img/c14.jpg" alt="">
						      <div class="content-details fadeIn-bottom">
							        <div class="bottom d-flex align-items-center justify-content-center">
										<a href="#"><span class="lnr lnr-heart"></span></a>
										<!-- <a href="#"><span class="lnr lnr-layers"></span></a>
